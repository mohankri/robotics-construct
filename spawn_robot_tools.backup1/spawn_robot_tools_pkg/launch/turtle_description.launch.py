...
def generate_launch_description():
    ...
    publish_robot_description = Node(
        ...
        name='turtle_robot_description_publisher',
        output='screen',
        emulate_tty=True,
        arguments=['-xml_string', xml,
                   '-robot_description_topic', '/turtle_robot_description'
                   ]
    )
    ...
    robot_state_publisher_node = Node(
        ...
        name='turtle_robot_state_publisher',
        emulate_tty=True,
        parameters=[{'use_sim_time': use_sim_time, 'robot_description': xml}],
        remappings=[("/robot_description", "/turtle_robot_description")
        ],
        output="screen"
    )
